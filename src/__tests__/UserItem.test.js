...
test('In edit mode, the checkbox has to be disabled', async () => {
    render(<UserItem user={userData} isEdit={true}/>);
    const userCheckbox = await screen.findAllByTestId('user-checkbox');
